...
function Shirts() {
  ...
  // Sample card data for Shirts with size, color, and category
  const cards = [
    {
      title: "Casual Shirt",
      price: "$40",
    ...
    },
    {
      title: "Plaid Shirt",
      price: "$30",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Plaid+Shirt",
      size: "S",
      color: "green",
      category: "Child",
    },
    {
      ...
      price: "$50",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Checkered+Shirt",
      size: "XL",
      color: "red",
      category: "Men",
    },
    {
      ...
      price: "$35",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Button-Down+Shirt",
      size: "XXL",
      color: "white",
      category: "Child",
    },
