...
function TShirts() {
  ...
  // Sample card data for T-shirts with size, color, and category
  const cards = [
    {
      title: "Graphic T-Shirt",
      price: "$30",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Graphic+T-Shirt",
      size: "M",
      color: "black",
      category: "Men",
    },
    {
      title: "Plain T-Shirt",
      price: "$25",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Plain+T-Shirt",
      size: "L",
      color: "blue",
      category: "Men",
    },
    {
      ...
      price: "$28",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Striped+T-Shirt",
      size: "S",
      color: "green",
      category: "Child",
    },
    {
      ...
      price: "$35",
      image: "https://via.placeholder.com/150/ffffff/000000?text=V-Neck+T-Shirt",
      size: "XL",
      color: "red",
      category: "Men",
    },
    {
      ...
      price: "$40",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Tie-Dye+T-Shirt",
      size: "XXL",
      color: "white",
      category: "Child",
    },
    {
      ...
      price: "$50",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Cotton+T-Shirt",
      size: "L",
      color: "blue",
      category: "Men",
    },
