...
function Sweaters() {
  ...
  // Sample card data for Sweaters with size, color, and category
  const cards = [
    {
      title: "V-Neck Sweater",
      price: "$30",
      image: "https://via.placeholder.com/150/ffffff/000000?text=V-Neck+Sweater",
      size: "M",
      color: "black",
      category: "Men",
    },
    {
      ...
      price: "$35",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Crew+Neck+Sweater",
      size: "L",
      color: "blue",
      category: "Men",
    },
    {
      ...
      price: "$40",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Cardigan+Sweater",
      size: "S",
      color: "green",
      category: "Child",
    },
    {
      ...
      price: "$45",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Cable+Knit+Sweater",
      size: "XL",
      color: "red",
      category: "Men",
    },
    {
      ...
      price: "$50",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Pullover+Sweater",
      size: "XXL",
      color: "white",
      category: "Child",
    },
    {
      ...
      price: "$55",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Turtleneck+Sweater",
      size: "L",
      color: "blue",
      category: "Men",
    },
            ...
            filteredCards.map((card, index) => (
              <div key={index} className="w-full p-6 rounded-lg">
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="text-sm text-green-600 sm:text-base">{card.price}</p>
                </div>
              </div>
            ))
          ) : (
