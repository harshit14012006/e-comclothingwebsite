...
function Hoodies() {
  ...
  // Sample card data for Hoodies with size, color, and category
  const cards = [
    {
      title: "Basic Hoodie",
      price: "$50",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Basic+Hoodie",
      size: "M",
      color: "black",
      category: "Men",
    },
    {
      title: "Sports Hoodie",
      price: "$55",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Sports+Hoodie",
      size: "L",
      color: "blue",
      category: "Men",
    },
    {
      title: "Winter Hoodie",
      price: "$65",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Winter+Hoodie",
      size: "S",
      color: "green",
      category: "Child",
    },
    {
      ...
      price: "$60",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Graphic+Hoodie",
      size: "XL",
      color: "red",
      category: "Men",
    },
    {
      title: "Zipper Hoodie",
      price: "$45",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Zipper+Hoodie",
      size: "XXL",
      color: "white",
      category: "Child",
    },
    {
      ...
      price: "$70",
      image: "https://via.placeholder.com/150/ffffff/000000?text=Hooded+Sweatshirt",
      size: "L",
      color: "blue",
      category: "Men",
    },
